...
export default function UseStateAndCss() {    
    return (
        <div>
            ...
            <button className="blue">Go Blue</button>
            <button className="red">Go Red</button>
            <button className="green">Go Green</button>

            <p className="blue">There once was a princess named Hank.</p>
        </div>
    )
}