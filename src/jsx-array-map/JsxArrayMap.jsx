...
export default function JsxArrayMap() {
    ...
    return (
        <div>
            ...
            <hr/>
            <BobRossQuote quote={quotes[0]} />
            <BobRossQuote quote={quotes[1]} />
            <BobRossQuote quote={quotes[2]} />
            <BobRossQuote quote={quotes[3]} />
            <BobRossQuote quote={quotes[4]} />
            <BobRossQuote quote={quotes[5]} />
        </div>
    )
}