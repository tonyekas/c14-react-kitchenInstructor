  ...
  return (
    <div>
      ...
      <ol>
        ...
        <li>Try your own solution using your memory and creativity, fall back to level 2 if there is a struggle</li>
        ...
        <li>Try a different way by changing the balance of the component hierarchy, JSX / CSS / JavaScript</li>
      </ol>
      ...
      <p>If you work with these topics every day, you will reach level 5 for all foundational topics here by the end of the program.  Strive to generally operate at level 3-4 when engaging new problems.</p>
    </div>
  )
}
