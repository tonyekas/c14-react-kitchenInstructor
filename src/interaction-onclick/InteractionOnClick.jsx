...
export default function InteractionOnClick() {
    // Create a function to call alert('Hello!') and bind it to the button below.

    // You can use the "onClick" prop to attach a function to the click event of the button.
